...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_no_data_found, 1);
        sViewsWithIds.put(R.id.tv_test, 2);
        sViewsWithIds.put(R.id.rv_test, 3);
    ...
    @NonNull
    public final android.support.v7.widget.RecyclerView rvTest;
    @NonNull
    public final android.widget.TextView tvNoDataFound;
    @NonNull
    ...
    public ActivityMainBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.ivAdd = (android.widget.ImageView) bindings[5];
        this.mboundView0 = (android.widget.LinearLayout) bindings[0];
        this.mboundView0.setTag(null);
        this.progressBar = (android.widget.ProgressBar) bindings[4];
        this.rvTest = (android.support.v7.widget.RecyclerView) bindings[3];
        this.tvNoDataFound = (android.widget.TextView) bindings[1];
        this.tvTest = (android.widget.TextView) bindings[2];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater, com.inexture.kotlinex.R.layout.activity_main, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.inexture.kotlinex.R.layout.activity_main, null, false), bindingComponent);
    }
    @NonNull
